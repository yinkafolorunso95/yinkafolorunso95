...
pygame.display.set_caption('Yinkas Naughts and Crosses')
...
again_rect = (screen_width // 2 - 80, screen_height // 2, 160, 50)
...
while run:
    ...
    if game_over == True:
        ...
        #check for mouseclick to see if user has clicked play again
        if event.type == pygame.MOUSEBUTTONDOWN and clicked == False:
                    clicked = True
        if event.type == pygame.MOUSEBUTTONUP and clicked == True:
                    clicked = False
